      ...
      <div className="register-form">
        ...
        <form className="register-form-d1">
          ...
          <div className="input-box">
            ...
            <input className="for-email" type="email" id="email" name="email" placeholder="Email" />
          </div>
          <div className="input-box">
          ...
          <div className="input-box">
            ...
            <input className="for-confirm-password" type="password" id="confirm-password" name="confirm-password" placeholder="Confirm password" />
          </div>
          <p>If you have already got an account. <a href="/login">Login Now</a></p>
        </form>
        <div className="register-btn-box">
          <button className="register-btn" type="button">Sign Up</button>
        </div>
      </div>
    </div>
  );
