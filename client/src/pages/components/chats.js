        ...
        <div>
            ...
            <div className="px-4 pb-4 dot-remove" dir="ltr">
                <div className="alice-carousel">
                    <div>
                        <div className="alice-carousel__wrapper" style={{ paddingLeft: '0px', paddingRight: '0px' }}>
                            <ul className="alice-carousel__stage" style={{ transition: 'transform 0ms ease 0ms', transform: 'translate3d(0px, 0px, 0px)' }}>
                                <li className="alice-carousel__stage-item __active __target" style={{ width: '83px' }}>
                                    <div className="item">
                                        <a href="#" className="user-status-box text-decoration-none">
