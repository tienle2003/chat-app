    ...
    <div className="login-page">
      <form className="login-form">
        ...
        <div className="input-box">
          ...
          <input className="for-username" type="text" id="username" name="username" placeholder="Username" />
        </div>
        <div className="input-box">
          ...
          <input className="for-password" type="password" id="password" name="password" placeholder="Password" />
        </div>
